...
As the HAL-Library is directly included into this project (CubeIDE compiled project), we are obliged to mention its
license, which is done in [LICENSE.md](LICENSE.md)
